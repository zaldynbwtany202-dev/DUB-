...
## ١. التشغيل على GitHub مباشرة (المنفّذ السحابي)

المستودع يحمل workflow جاهزًا (`.github/workflows/dub.yml`):

1. افتح المستودع على GitHub ← تبويب **Actions** ← **Dub a video** ← **Run workflow**.
2. الصق **رابط فيديو مباشر**، اختر لغة المصدر والهدف والمحرك.
