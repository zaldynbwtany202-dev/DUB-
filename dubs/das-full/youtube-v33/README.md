# Das full recap — voice-33 fluent dub

- Voice: `voice-33` only. No `add_voice`. No DSP. Mux only.
- Words: YouTube `unique.txt`
- Times: `library/das-full/youtube/NB2YcTh_L6k.spoken.srt`
